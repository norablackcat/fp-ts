import { Alt2C, Alt3C } from '../../src/Alt.ts'
import { Alternative2C, Alternative3C } from '../../src/Alternative.ts'
import { Applicative2C, Applicative3C } from '../../src/Applicative.ts'
import { Apply2C, Apply3C } from '../../src/Apply.ts'
import { Bifunctor2C, Bifunctor3C } from '../../src/Bifunctor.ts'
import { Chain2C, Chain3C } from '../../src/Chain.ts'
import { ChainRec2C, ChainRec3C } from '../../src/ChainRec.ts'
import { Comonad2C, Comonad3C } from '../../src/Comonad.ts'
import { Compactable2C, Compactable3C } from '../../src/Compactable.ts'
import { Contravariant2C, Contravariant3C } from '../../src/Contravariant.ts'
import { Extend2C, Extend3C } from '../../src/Extend.ts'
import { Filterable2C, Filterable3C } from '../../src/Filterable.ts'
import { FilterableWithIndex2C } from '../../src/FilterableWithIndex.ts'
import { Foldable2C, Foldable3C } from '../../src/Foldable.ts'
import { FoldableWithIndex2C, FoldableWithIndex3C } from '../../src/FoldableWithIndex.ts'
import { FromEither2C, FromEither3C } from '../../src/FromEither.ts'
import { FromIO2C, FromIO3C } from '../../src/FromIO.ts'
import { FromTask2C, FromTask3C } from '../../src/FromTask.ts'
import { Functor2C, Functor3C } from '../../src/Functor.ts'
import { FunctorWithIndex2C, FunctorWithIndex3C } from '../../src/FunctorWithIndex.ts'
import { Invariant2C, Invariant3C } from '../../src/Invariant.ts'
import { Monad2C, Monad3C } from '../../src/Monad.ts'
import { Pointed2C, Pointed3C } from '../../src/Pointed.ts'
import { Profunctor2C, Profunctor3C } from '../../src/Profunctor.ts'
import { Traversable2C } from '../../src/Traversable.ts'
import { TraversableWithIndex2C } from '../../src/TraversableWithIndex.ts'
import { Unfoldable2C, Unfoldable3C } from '../../src/Unfoldable.ts'
import { Witherable2C } from '../../src/Witherable.ts'
